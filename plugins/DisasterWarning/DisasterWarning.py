    ...
    def _load_config(self):
        ...
        default_config = {
            ...
            "weather_config": {
                ...
                "weather_filter": {"enabled": False, "provinces": [], "min_color_level": "白色"},
            },
            "message_format": {
                "include_map": False,
                "map_provider": "baidu",
...
更多信息可参考 README 文档"""
        ...
        await self.api.post_group_msg(group_id=input.group_id, text=help_text)
    ...
    async def _handle_stats(self, input: GroupMessage):
        ...
        try:
            ...
            await self.api.post_group_msg(group_id=input.group_id, text=stats_summary)
    ...
    async def _handle_test(self, input: GroupMessage, raw_message: str):
        ...
        try:
            ...
            if test_result and "✅" in test_result:
                await self.api.post_group_msg(group_id=input.group_id, text=test_result)
            else:
                await self.api.post_group_msg(
                    group_id=input.group_id,
...
📡 数据源统计："""
            ...
            await self.api.post_group_msg(group_id=input.group_id, text=log_info)
